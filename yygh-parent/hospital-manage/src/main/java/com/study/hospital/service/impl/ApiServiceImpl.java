...
import com.study.hospital.mapper.HospitalSetMapper;
import com.study.hospital.mapper.ScheduleMapper;
import com.study.hospital.model.HospitalSet;
import com.study.hospital.model.Schedule;
import com.study.hospital.service.ApiService;
import com.study.hospital.util.BeanUtils;
import com.study.hospital.util.HttpRequestHelper;
import com.study.hospital.util.MD5;
import com.study.hospital.util.YyghException;
...
public class ApiServiceImpl implements ApiService {
    ...
    public JSONObject getHospital() {
        ...
        //paramMap.put("sign", HttpRequestHelper.getSign(paramMap, apiService.getSignKey())); // 改
        paramMap.put("sign", MD5.encrypt(this.getSignKey())); // 改后
